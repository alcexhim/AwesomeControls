...
namespace AwesomeControls.Theming.BuiltinThemes
{
	public class Office2003Theme : OfficeXPTheme
	{
		...
		protected override void InitCommonColors()
		{
			...
			if (!UseLowResolution)
			{
				ColorTable.ButtonPressedHighlight = ColorTable.GetAlphaBlendedColor(SystemColors.Window, ColorTable.GetAlphaBlendedColor(SystemColors.Highlight, SystemColors.Window, 160), 50);
				ColorTable.ButtonCheckedHighlight = ColorTable.GetAlphaBlendedColor(SystemColors.Window, ColorTable.GetAlphaBlendedColor(SystemColors.Highlight, SystemColors.Window, 80), 20);
				ColorTable.ButtonSelectedHighlight = ColorTable.ButtonCheckedHighlight;
				return;
			}
			ColorTable.ButtonPressedHighlight = SystemColors.Highlight;
			ColorTable.ButtonCheckedHighlight = SystemColors.ControlLight;
			ColorTable.ButtonSelectedHighlight = SystemColors.ControlLight;
		}
		protected override void InitSystemColors()
		{
			...
			if (UseLowResolution || UseHighContrast)
			{
				...
				ColorTable.CommandBarControlBackgroundSelectedHover = SystemColors.ControlLight;
			...
			ColorTable.CommandBarControlBackgroundSelected = (UseLowResolution ? SystemColors.ControlLight : highlight);
			...
			ColorTable.DocumentTabBorderDarkHover = SystemColors.MenuText;
			ColorTable.DocumentTabBorderHighlight = buttonFace;
			ColorTable.DocumentTabBorderHighlightPressed = highlight;
			ColorTable.DocumentTabBorderHighlightHover = SystemColors.MenuText;
			ColorTable.DocumentTabBorderPressed = highlight;
			ColorTable.DocumentTabBorderHover = SystemColors.MenuText;
			...
			ColorTable.DockingWindowActiveTabBackgroundGradientBegin = buttonShadow;
			ColorTable.DockingWindowActiveTabBackgroundGradientMiddle = buttonShadow;
			ColorTable.DockingWindowActiveTabBackgroundGradientEnd = buttonShadow;
			ColorTable.DockingWindowActiveTabText = controlText;
			...
			ColorTable.FocuslessHighlightedBackground = SystemColors.InactiveCaption;
			ColorTable.FocuslessHighlightedForeground = SystemColors.InactiveCaptionText;
			...
			ColorTable.WordProcessorInfoTipBackground = SystemColors.Info;
			ColorTable.WordProcessorInfoTipText = SystemColors.InfoText;
		...
		protected override void InitBlueLunaColors()
		{
			...
			ColorTable.DockingWindowActiveTabBackgroundGradientBegin = Color.FromArgb(186, 211, 245);
			ColorTable.DockingWindowActiveTabBackgroundGradientMiddle = Color.FromArgb(186, 211, 245);
			ColorTable.DockingWindowActiveTabBackgroundGradientEnd = Color.FromArgb(186, 211, 245);
			ColorTable.DockingWindowActiveTabText = Color.FromArgb(0, 0, 0);
		...
		protected override void InitOliveLunaColors()
		{
			...
			ColorTable.DocumentTabTextHover = Color.FromArgb(0, 0, 0);
			ColorTable.DocumentTabTextSelected = Color.FromArgb(0, 0, 0);
			ColorTable.DockingWindowActiveTabBackgroundGradientBegin = Color.FromArgb(218, 227, 187);
			ColorTable.DockingWindowActiveTabBackgroundGradientMiddle = Color.FromArgb(218, 227, 187);
			ColorTable.DockingWindowActiveTabBackgroundGradientEnd = Color.FromArgb(218, 227, 187);
			ColorTable.DockingWindowActiveTabText = Color.FromArgb(0, 0, 0);
		...
		protected override void InitRoyaleColors()
		{
			...
			ColorTable.DockingWindowActiveTabBackgroundGradientBegin = Color.FromArgb(255, 51, 153);
			ColorTable.DockingWindowActiveTabBackgroundGradientMiddle = Color.FromArgb(255, 51, 153);
			ColorTable.DockingWindowActiveTabBackgroundGradientEnd = Color.FromArgb(255, 51, 153);
			ColorTable.DockingWindowActiveTabText = Color.FromArgb(255, 51, 153);
		...
		protected override void InitSilverLunaColors()
		{
			...
			ColorTable.DocumentTabTextHover = Color.FromArgb(0, 0, 0);
			ColorTable.DocumentTabTextSelected = Color.FromArgb(0, 0, 0);
			ColorTable.DockingWindowActiveTabBackgroundGradientBegin = Color.FromArgb(212, 212, 226);
			ColorTable.DockingWindowActiveTabBackgroundGradientMiddle= Color.FromArgb(212, 212, 226);
			ColorTable.DockingWindowActiveTabBackgroundGradientEnd = Color.FromArgb(212, 212, 226);
			ColorTable.DockingWindowActiveTabText = Color.FromArgb(0, 0, 0);
			ColorTable.DockingWindowActiveTabText = Color.FromArgb(0, 0, 0);
		...
		protected void RenderBackgroundGradient(Graphics g, Control control, Color beginColor, Color endColor, Orientation orientation)
		{
		...
		private void RenderOverflowBackground(Graphics graphics, ToolStripItem item, ToolStrip parent, bool rightToLeft)
		{
			...
			bool flag2 = parent.Orientation == Orientation.Horizontal;
			if (flag2)
			{
		...
		public override void DrawGrip(Graphics graphics, Rectangle gripBounds, ToolStrip toolStrip)
		{
		...
		public override void DrawCommandBarBackground(Graphics graphics, ToolStrip parent)
		{
			...
			{
				RenderBackgroundGradient(graphics, parent, ColorTable.CommandBarPanelGradientBegin, ColorTable.CommandBarPanelGradientEnd, parent.Orientation);
				return;
			}
			if (parent is StatusStrip)
			{
				RenderBackgroundGradient(graphics, parent, this.ColorTable.CommandBarPanelGradientBegin, this.ColorTable.CommandBarPanelGradientEnd, parent.Orientation);
				return;
			}
			Rectangle bounds = new Rectangle(Point.Empty, parent.Size);
			LinearGradientMode mode = (parent.Orientation == Orientation.Horizontal) ? LinearGradientMode.Vertical : LinearGradientMode.Horizontal;
			DrawingTools.FillWithDoubleGradient(ColorTable.CommandBarGradientVerticalBegin, ColorTable.CommandBarGradientVerticalMiddle, ColorTable.CommandBarGradientVerticalEnd, graphics, bounds, 12, 12, mode, false);
		}
