...
namespace AwesomeControls.Theming
{
	public abstract class Theme
	{
		...
		public virtual void DrawRibbonTab(Graphics graphics, Rectangle bounds, ControlState state, Ribbon.RibbonTab tab)
		{
			...
			TextRenderer.DrawText(graphics, tab.Text, font, bounds, ColorTable.RibbonTabText, TextFormatFlags.HorizontalCenter | TextFormatFlags.VerticalCenter);
			#endregion
		}
		public virtual void DrawRibbonControlGroup(Graphics g, Rectangle rect, Ribbon.RibbonControlGroup group)
		{
			Font font = System.Drawing.SystemFonts.MenuFont;
			font = new Font(font.FontFamily, 8, FontStyle.Regular);

			TextRenderer.DrawText(g, group.Text, font, rect, ColorTable.RibbonControlGroupText, TextFormatFlags.Bottom | TextFormatFlags.HorizontalCenter);
		}
		public virtual void DrawRibbonControl(Graphics g, Rectangle rect, Ribbon.RibbonControl ctl)
		{
			if (ctl.DisplayStyle == Ribbon.RibbonControlDisplayStyle.ImageAboveText)
			{
		...
		public static Theme[] GetAvailableThemes()
		{
			if (mvarAvailableThemes == null)
			{
				...
				System.Reflection.Assembly[] asms = Mirror.Methods.GetAvailableAssemblies();
		...
		#region DockPanel
		public virtual void DrawDocumentTabBackground(Graphics g, Rectangle rectTab, ControlState controlState, AwesomeControls.DockingWindows.DockPosition position, bool selected, bool focused)
		{
		}
		public virtual void DrawDockPanelTabBackground(Graphics g, Rectangle rectTab, ControlState controlState, AwesomeControls.DockingWindows.DockPosition position, bool selected, bool focused)
		{
		}
		#endregion
		...
		#region Accordion
		/// <summary>
		/// Draws the background of an <see cref="AwesomeControls.Accordion.AccordionControl" />.
		/// </summary>
		/// <param name="rectangle"></param>
