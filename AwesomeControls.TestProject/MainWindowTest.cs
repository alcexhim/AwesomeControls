...
namespace AwesomeControls.TestProject
{
	public partial class MainWindowTest : AwesomeControls.Window
	{
		public MainWindowTest()
		{
			...
			DockingWindow wndTeamExplorer= dcc.Windows.Add("wndTeamExplorer", "Team Explorer", new AwesomeControls.ListView.ListViewControl());
			...
			dcc.Areas[DockPosition.Right].Areas[DockPosition.Top].Windows.Add(wndTeamExplorer);
